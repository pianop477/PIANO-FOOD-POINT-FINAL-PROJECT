        ...
        <div class="container" style="width: 50%; align-content: center;">
            <form action="#" method="POST">
                ...
                <div class="form-group" style="display: flex; justify-content: space-between">
                    <button type="submit" name="send_order" class="btn btn-success"><i class="fa fa-send"></i>  SEND ORDER</button>
                    <span class="fa fa-arrow-circle-left fa-lg"><a href="index.php" style="color: red;"> BACK</a></span>
                </div>
            </form>
        </div>
        </div>
