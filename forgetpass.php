        ...
        <div>
            ...
            <div class="container-fluid width" style="width: 50%; align-content: center;">
                ...
                <form action="" method="POST">
                    ...
                    <input type="email" name="emailfoget" placeholder="Email Address" class="form-control">
                    </div>
                    <div class="form-group">
                        <input type="password" name="passwordfoget" placeholder="Enter New Password" class="form-control">
                    </div>
                    <div class="form-group">
                        <input type="password" name = "cofirm_pass" placeholder="Confirm Password" class="form-control">
                    </div>
                    <div class="form-group" style="display: flex; justify-content: space-between; align-items: center;">
                        <button type="submit" name="reset-password" class="btn btn-success">Change Password</button>
